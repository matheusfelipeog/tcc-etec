...
// print_r($data);     // Variável contendo o array associativo de todos os dados

// print_r ($_FILES);  // Request do tipo Files para envio dos arquivos
...
curl_setopt_array($curl, [
    ...
    CURLOPT_URL => 'http://localhost/controller/estoque/estoque.Atualizar.php', // URL DE DESTINO AQUI
    CURLOPT_POST => 1,
